<template>
  <div>
    ...
    -->
    <div :class="`pb-12 bg-poly bg-poly-${num} h-72 lg:h-88 ios:h-72 sm:ios:h-72 lg:ios:h-72 xl:ios:h-88 relative -mb-2`">
      <div class="px-4 lg:px-16 flex flex-col h-full">
        <slot/>
      </div>
      <wave :num="num"/>
    </div>
...
@Component({
  name: 'home-header',
  components: { Wave, HomeHeaderButton }
})
