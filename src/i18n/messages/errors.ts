export default {
  en: {
    'errors': {
      ...
      'alphanumeric-error': 'The {param} can contain only letters and numbers',
      'alphanumeric-error-short': 'Only letters and numbers',
      ...
      'tag-some-user': 'Please tag at least one person',
      ...
      'NoMoreAdmins': 'You cannot leave a group if you are the only admin',
      'user-is-only-admin-of-some-group': 'You are the only admin of some group, please contact us to remove the group and your account'
    }
  },
  es: {
    'errors': {
      ...
      'alphanumeric-error': 'El {param} solo puede contener letras y números',
      'alphanumeric-error-short': 'Solo letras y números',
      ...
      'select-some-picture': 'Por favor suba al menos una foto',
      'tag-some-user': 'Por favor etiquete alguna persona',
      ...
      'NoMoreAdmins': 'No puedes abandonar un grupo si eres el único administrador',
      'user-is-only-admin-of-some-group': 'Eres el único administrador de un grupo, por favor contáctanos para eliminar el grupo y tu cuenta'
    }
  }
}
